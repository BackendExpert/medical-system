                    ...
                    $patient = "
                        <tr>
                            ...
                            if($next_ch_date_r['ch_date'] == $check_date){
                                $patient .="<td><span style='color:green;'>Channel Patient</span> <br><a href=''><button class='btn btn-success'>Channel Patient</button></a>/<a href='patient/book_adate.php?id=".$row['id']."'><button class='btn btn-info'>Change Date</button></a></td>";
                            }
